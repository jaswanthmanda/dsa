...
the DAG, where edges[i] = [ui, vi] indicates
...
Notes:
- A cycle is a series of nodes a1, a2, ..., an, an+1 such that node a1 is the same node as node an+1, the nodes a1, a2, ..., an are distinct, and there
  is a directed edge from the node ai to node ai+1 for every i in the range [1, n].
...
Output: -1
Explanation:
Team 2 is weaker than team 0 and team 1. Team 3 is weaker than team 1.
