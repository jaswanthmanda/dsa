...
Return an array baseUnitConversion of length n, where baseUnitConversion[i] is the number
of units of type i equivalent to a single unit of type 0.
Since the answer may be large, return each baseUnitConversion[i] modulo 109 + 7.
"""
"""
Example 1:
...
- It is guaranteed that unit 0 can be converted into any other unit through a unique
